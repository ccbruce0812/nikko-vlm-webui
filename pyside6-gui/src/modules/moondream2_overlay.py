"""
Moondream2 overlay: draws a semi-transparent black bar at the image bottom
...
def draw_overlay(qimage: QImage, response_text: str) -> QImage:
    """Draw semi-transparent caption bar with Moondream2 response."""
    return _draw_caption(qimage, response_text)


def prepare_payload(frame: QImage, prompt: str, max_tokens: int) -> str:
    """Resize, JPEG-encode, build Router API JSON payload for Moondream2."""
    import json
